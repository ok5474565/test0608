...
def main():
    ...
    if uploaded_file:
        ...
        plt.plot(s_curve_normalized_index, s_curve.values, 'r--', label='S 曲线 - 学生表现', fontproperties=chinese_font)
        plt.plot(p_curve_normalized_index, p_curve.values, 'b-', label='P 曲线 - 问题难度', fontproperties=chinese_font)
