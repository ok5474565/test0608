...
def main():
    ...
    if uploaded_file:
        ...
        # 准备 ECharts 数据
        s_curve_data = [{'index': idx, 'value': val} for idx, val in enumerate(s_curve.values)]
        p_curve_data = [{'index': idx, 'value': val} for idx, val in enumerate(p_curve.values)]
            ...
            "series": [
                {
                    "name": 'S 曲线 - 学生表现',
                    "type": 'line',
                    "data": [val['value'] for val in s_curve_data],
                    "lineStyle": {
                        "type": 'dashed',
                        "color": 'red'
                    }
                },
                {
                    "name": 'P 曲线 - 问题难度',
                    "type": 'line',
                    "data": [val['value'] for val in p_curve_data],
                    "lineStyle": {
                        "color": 'blue'
                    }
                }
